                    ...
                    <div class="col-xs-12">
                        <spring:bind path="ingredients">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                ...
                                <button type="button" class="btn btn-default btn-xs" data-role="ajouterSel"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Sel </button>
                                <button type="button" class="btn btn-default btn-xs" data-role="ajouterPoivre"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Poivre </button>
                                <div id="ingredients">
